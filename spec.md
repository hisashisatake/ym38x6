...
| AT Destination | Channel Pressureの加算先（destination enum、下記参照） |
| Poly AT Destination | Poly Key Pressureの加算先（destination enum、下記参照） |

### アフタータッチ（Channel Pressure / Poly Key Pressure）
